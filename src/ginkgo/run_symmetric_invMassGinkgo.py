...
if save:
    ...
    simulator.save(jet_list, args.out_dir, "symm_jets"+str(args.jetType)+"_" + str(args.minLeaves) + "N_"+ str(args.Nsamples)+"trees_"+str(int(10*np.sqrt(pt_min)))+"tcut_"+ str(args.id))

# To run: python run_invMassGinkgo.py --jetType=W --Nsamples=2 --id=0
#         python run_invMassGinkgo.py --jetType=QCD --Nsamples=2 --id=0
#     python run_symmetric_invMassGinkgo.py --jetType=QCD --Nsamples=100 --minLeaves=9 --maxLeaves=10 --maxNTry=20000