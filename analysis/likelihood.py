...
if __name__=='__main__':
  ...
  root_node_id=0
  brach_log_likelihood = traverse_likelihood(jet_dic, root_id=root_node_id, parent_id=-1)

  print('Branch log likelihood from root id:'+str(root_node_id)+' =', brach_log_likelihood)